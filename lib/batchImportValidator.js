...
export function validateBatchImport(db, animalsInput) {
  const result = {
...
export function getValidImportItems(db, animalsInput) {
  const validation = validateBatchImport(db, animalsInput);
